                ...
                <Content style={{ padding: '0 50px' }}>
                    <div className="site-layout-content">
                        ...
                        <Form {... layout} name="basic" initialValues={{ remember: true, }}
                            onFinish={onFinish} >
                            <Form.Item 
                                label="Código do ativo" name="codigoAtivo"                                
                                rules={[
                                {
                                    required: true, message: 'Insira o código do ativo!',
                                },
                                ]}
                            >
                                <Input/>
                            ...
                            <Form.Item 
                                label="Valor" name="valorCota"       
                                rules={[
                                {
                                    required: true, message: 'Insira o valor da cota!',
                                },
                                ]}
                            >
                                <InputNumber/>
                            ...
                            <Form.Item
                                label="Quantidade de cotas" name="quantidadeCotas"
                                rules={[
                                    {
                                        required: true,
                            ...
                            <Form.Item
                                label="Data da compra" name="dataCompra"
                                rules={[
                                    {
                                        required:true,
